...
def Update_Profile_Picture(_id):
...
def Update_Experience_Info(_id):
    data = users.find_one({"_id" : ObjectId(_id)})
...
def Update_Accomplishments_Info(_id):
    data = users.find_one({"_id" : ObjectId(_id)})
...
# test_id = "5f43a9f4afd2ef31944a9146"

# Update_Profile_Picture(test_id)
# Update_Story_Info(test_id)
# Update_Headline_Info(test_id)
# Update_Interests_Info(test_id)
# Update_Accomplishments_Info(test_id)
# Update_Language_Info(test_id)
# Update_Education_Info(test_id)
# Update_Experience_Info(test_id)
